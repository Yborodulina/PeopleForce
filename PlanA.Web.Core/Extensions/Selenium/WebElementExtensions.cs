...
public static class WebElementExtensions
{
    ...
    public static IWebElement Refresh(this IWebElement element)
    {
        return Driver.Instance.FindElement(By.XPath(element.GetXPathAsString()));
    }
    ...
    public static IWebElement
        TypeIntoAndSubmit(this IWebElement element, string text) //TODO Replace with SendKeyAndSubmit
    {
    ...
    public static void SetAttribute(this IWebElement element, string attName, String attValue)
    {
        Driver.Instance.ExecuteScript("arguments[0].setAttribute(arguments[1], arguments[2]);",
